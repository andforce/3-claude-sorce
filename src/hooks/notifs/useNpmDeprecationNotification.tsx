...
const NPM_DEPRECATION_MESSAGE = 'OpenClaude has switched from npm to native installer. Run `openclaude install` or see https://docs.anthropic.com/en/docs/claude-code/getting-started for more options.';
