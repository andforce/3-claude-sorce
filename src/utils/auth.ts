 ...
 * to the user's ~/.openclaude/settings.json API-key config (apiKeyHelper,
...
export function isAnthropicAuthEnabled(): boolean {
  ...
  // ~/.openclaude settings (apiKeyHelper, settings.env.ANTHROPIC_API_KEY) MUST NOT
 ...
 * from ~/.openclaude/settings.json or project settings is ignored.
 */
